...
namespace TodoApp.Backend.Controllers
{
    ...
    {
        private readonly TodoAppBackendContext _context;

        public TasksController(TodoAppBackendContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Task>> PostTask(Task task)
        {
          if (_context.Task == null)
          {
              return Problem("Entity set 'TodoAppBackendContext.Task'  is null.");
          }
